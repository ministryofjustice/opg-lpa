...
casper.test.begin("Checking user can add donor", {
    ...
    test: function(test) {
        ...
        casper.start(basePath + donorPath).then(function () {
            ...
            test.assertExists('div#popup', "Lightbox for selecting an actors details to use for a donor is loaded and displayed as expected");
            ...
            return this.exists('form#form-donor');
        ...
        }).wait(15000).thenClick('a[href="'+whenLpaStartsPath+'"]', function() {
