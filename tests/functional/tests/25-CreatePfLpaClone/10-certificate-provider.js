...
casper.test.begin("Checking user can add certificate provider", {
    ...
    test: function(test) {
        ...
        casper.start(basePath + certificateProviderPath).then(function () {
            ...
            test.assertExists('div#popup', "Lightbox for selecting an actors details to use for a certificate provider is loaded and displayed as expected");
            ...
            return this.exists('form#form-certificate-provider');
        ...
        }).wait(15000).waitForSelector('div.person', function then () {
        ...
        }).wait(15000).thenClick('a[href="'+peopleToNotifyPath+'"]', function() {
