...
casper.test.begin("Checking user can add donor", {
    ...
    tearDown: function(test) {
        delete donorPath, lifeSustainingPath;
    },
    ...
    test: function(test) {
        ...
        casper.start(basePath + donorPath).then(function () {
            ...
            // Check the save button isn't currently there
            test.assertDoesntExist('a.button[href="'+lifeSustainingPath+'"]', 'Save button currently is not shown');
            ...
            test.assertExists('a.button[href="'+lifeSustainingPath+'"]', 'Save button currently is shown');
        ...
        }).wait(1500).thenClick('a[href="'+lifeSustainingPath+'"]', function() {
            ...
            test.assertUrlMatch(new RegExp('^' + basePath + lifeSustainingPath + '$'), 'Page is on the expected URL: ' + this.getCurrentUrl());
