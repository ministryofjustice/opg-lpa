;(function (global) {
  ...
  const GoogleAnalyticsUniversalTracker = function (trackingId, fieldsObject) {
    this.trackerDomains = []
  ...
  GoogleAnalyticsUniversalTracker.prototype.trackPageview = function (path, title, options) {
    ...
    if (typeof options === 'object') {
      pageviewObject = _.extend(pageviewObject || {}, options)
    }

    if (pageviewObject === null) {
      sendToGa('send', 'pageview')
      this.trackerDomains.forEach(function (domain) {
  ...
  GoogleAnalyticsUniversalTracker.prototype.trackSocial = function (network, action, target, options) {
    ...
    _.extend(trackingOptions, options)
