...
;(function () {
  ...
  const hasCleanFields = function (context) {
    let clean = true
  ...
  PostcodeLookup.prototype = {
    ...
    // wrap is the container element for the postcode lookup component
    cacheEls: function (wrap) {
      this.wrap = wrap
      this.postalForm = this.wrap.querySelector('.js-PostcodeLookup__postal-add')
    ...
    init: function () {
      ...
      if (hasCleanFields(this.postalForm) && document.querySelector('.error-summary') === null) {
        this.wrap.querySelector('[data-role=postcodelookup-search]').classList.add('hidden')
      } else {
        this.hideSearchForm()
        this.toggleAddress()
      }
    ...
    hideSearchForm: function () {
      this.wrap.querySelector('.js-PostcodeLookup__search').classList.add('hidden')
    ...
    changeClicked: function (e) {
      ...
      this.wrap.querySelector('.js-PostcodeLookup__search').classList.remove('hidden')
      if (hasCleanFields(this.postalForm) && document.querySelector('.error-summary') === null) {
        this.$wrap.find('.js-PostcodeLookup__toggle-address').closest('div').removeClass('hidden')
      }
      this.wrap.querySelector('.js-PostcodeLookup__query').focus()
      return false
    },
