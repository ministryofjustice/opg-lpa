...
class TypeControllerTest extends AbstractControllerTest
{
    ...
    public function testIndexActionPostFailed()
    {
        ...
        $this->lpaApplicationService->shouldReceive('setType')->withArgs([$this->lpa->id, $this->postData['type']])->andReturn(false)->once();
    ...
    public function testIndexActionPostSuccess()
    {
        ...
        $this->setPostValid($this->form, $this->postData);
        $this->form->shouldReceive('getData')->andReturn($this->postData)->once();
        $this->lpaApplicationService->shouldReceive('setType')->withArgs([$this->lpa->id, $this->postData['type']])->andReturn(true)->once();
