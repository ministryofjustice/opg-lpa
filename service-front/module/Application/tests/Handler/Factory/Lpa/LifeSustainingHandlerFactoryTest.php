...
class LifeSustainingHandlerFactoryTest extends TestCase
{
    public function testFactoryCreatesHandler(): void
    {
        ...
        $factory = new LifeSustainingHandlerFactory();
        $handler = $factory($container);

        $this->assertInstanceOf(LifeSustainingHandler::class, $handler);
    }
}
