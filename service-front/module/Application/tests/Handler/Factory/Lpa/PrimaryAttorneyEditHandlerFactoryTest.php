...
class PrimaryAttorneyEditHandlerFactoryTest extends TestCase
{
    public function testFactoryCreatesHandler(): void
    {
        ...
        $factory = new PrimaryAttorneyEditHandlerFactory();
        $handler = $factory($container);

        $this->assertInstanceOf(PrimaryAttorneyEditHandler::class, $handler);
    }
}
