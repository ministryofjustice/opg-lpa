...
class ReplacementAttorneyAddHandlerFactoryTest extends TestCase
{
    public function testFactoryCreatesHandler(): void
    {
        ...
        $factory = new ReplacementAttorneyAddHandlerFactory();
        $handler = $factory($container);

        $this->assertInstanceOf(ReplacementAttorneyAddHandler::class, $handler);
    }
}
