...
class ReplacementAttorneyEditHandlerFactoryTest extends TestCase
{
    public function testFactoryCreatesHandler(): void
    {
        ...
        $factory = new ReplacementAttorneyEditHandlerFactory();
        $handler = $factory($container);

        $this->assertInstanceOf(ReplacementAttorneyEditHandler::class, $handler);
    }
}
