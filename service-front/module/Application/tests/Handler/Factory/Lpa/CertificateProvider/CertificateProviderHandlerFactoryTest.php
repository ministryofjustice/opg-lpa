...
class CertificateProviderHandlerFactoryTest extends TestCase
{
    public function testFactoryCreatesHandler(): void
    {
        ...
        $factory = new CertificateProviderHandlerFactory();
        $handler = $factory($container);

        $this->assertInstanceOf(CertificateProviderHandler::class, $handler);
    }
}
