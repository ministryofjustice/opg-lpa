...
class CompleteViewDocsHandlerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->handler = new CompleteViewDocsHandler(
            $this->renderer,
    ...
    private function createRequest(?Lpa $lpa = null): ServerRequest
    {
        ...
        return (new ServerRequest())
            ...
            ->withAttribute(RequestAttribute::CURRENT_ROUTE_NAME, 'lpa/view-docs');
    }
    ...
    public function testRendersCorrectTemplate(): void
    {
        $this->renderer->expects($this->once())->method('render')
            ->with('application/authenticated/lpa/complete/view-docs.twig', $this->anything())
            ->willReturn('html');
    ...
    public function testViewParamsFromHelperPassedToRenderer(): void
    {
        ...
        $handler = new CompleteViewDocsHandler(
            $this->renderer,
            $this->lpaApplicationService,
