...
class LpaLoaderMiddlewareTest extends TestCase
{
    ...
    public function testReturns404WhenLpaNotFound(): void
    {
        ...
        $this->authenticationService->method('getIdentity')->willReturn($this->createUserIdentity('user-123'));
    ...
    public function testThrowsExceptionWhenUserDoesNotOwnLpa(): void
    {
        ...
        $this->authenticationService->method('getIdentity')->willReturn($this->createUserIdentity('user-456'));
