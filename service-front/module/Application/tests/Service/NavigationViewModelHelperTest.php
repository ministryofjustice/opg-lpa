...
class NavigationViewModelHelperTest extends TestCase
{
        ...
        $this->sessionUtility
            ...
            ->willReturnCallback(function ($namespace, $key) {
                return match ([$namespace, $key]) {
                    ...
                    ['UserDetails', 'hasOneOrMoreLPAs'] => false,
                    default => null,
                };
            });
    ...
    public function testBuildWhenUserLoggedInWithFullDetails(): void
    {
        ...
        $this->sessionUtility
            ...
            ->willReturnCallback(function ($namespace, $key) use ($user) {
                return match ([$namespace, $key]) {
                    ...
                    ['UserDetails', 'hasOneOrMoreLPAs'] => true,
                    default => null,
                };
            });
        ...
        $this->sessionUtility
            ->expects($this->once())
            ->method('hasInMvc')
            ->with('UserDetails', 'hasOneOrMoreLPAs')
            ->willReturn(true);
    ...
    public function testBuildWhenUserLoggedInWithoutName(): void
    {
        ...
        $this->sessionUtility
            ->expects($this->once())
            ->method('setInMvc')
            ->with('UserDetails', 'hasOneOrMoreLPAs', false);
    ...
    public function testBuildWhenUserLoggedInAndNeedsToCheckLpas(): void
    {
        ...
        $this->sessionUtility
            ...
            ->willReturnCallback(function ($namespace, $key) use ($user) {
                return match ([$namespace, $key]) {
                    ['UserDetails', 'user'] => $user,
                    ['UserDetails', 'hasOneOrMoreLPAs'] => null,
                    default => null,
                };
            });
        ...
        $this->sessionUtility
            ->expects($this->once())
            ->method('setInMvc')
            ->with('UserDetails', 'hasOneOrMoreLPAs', true);
