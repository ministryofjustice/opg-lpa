...
class RouteMatchMiddleware implements MiddlewareInterface
{
    public function process(ServerRequestInterface $request, RequestHandlerInterface $handler): ResponseInterface
    {
        ...
        // Already bridged by a previous middleware in the pipe – skip.
        ...
        // We need a MiddlewareInterface stub as Route requires one, but it is
        // never invoked through this bridge – the real handler is already in
        // the pipeline.
        ...
        $route = new Route($routeName !== '' ? $routeName : '/', $stubMiddleware, null, $routeName);
