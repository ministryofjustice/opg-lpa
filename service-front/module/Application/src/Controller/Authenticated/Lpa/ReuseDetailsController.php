    ...
    public function indexAction()
    {
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                // If the target route uses PipeSpec (Mezzio handler), we can't use
                // forward() dispatch. Instead, redirect back with query params so the
                // handler can pick up the reuse details index.
                if ($controllerName === PipeSpec::class) {
