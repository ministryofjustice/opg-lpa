...
class HowReplacementAttorneysMakeDecisionHandler implements RequestHandlerInterface
{
    ...
    public function handle(ServerRequestInterface $request): ResponseInterface
    {
        ...
        $html = $this->renderer->render(
            'application/authenticated/lpa/how-replacement-attorneys-make-decision/index.twig',
            array_merge(
