...
namespace AppTest\Handler\Lpa\PeopleToNotify;
...
class PeopleToNotifyConfirmDeleteHandlerTest extends TestCase
{
    ...
    private function createRequest(Lpa $lpa, ?string $idx = '0', array $headers = []): ServerRequest
    {
        ...
        $route = new Route('/lpa/:lpa-id/people-to-notify/confirm-delete/:idx', new StubMiddleware(), null, 'lpa/people-to-notify/confirm-delete');
