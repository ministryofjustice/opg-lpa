...
final class ResendActivationEmailHandlerTest extends TestCase
{
    ...
    public function testDisplaysResendEmailFormOnGetRequest(): void
    {
        ...
        $this->formElementManager->expects($this->once())
            ->method('get')
    ...
    public function testSuccessfulResendDisplaysEmailSentPage(): void
    {
        ...
        $confirmForm->method('setAttribute')->with('action', '/signup/resend-email');
        $confirmForm->method('setData')->with($request->getParsedBody());
        $confirmForm->method('isValid')->willReturn(true);
        $confirmForm->method('getData')->willReturn(['email' => 'test@example.com']);
        ...
        $this->userService->method('resendActivateEmail')->with('test@example.com')->willReturn(true);
    ...
    public function testFailedResendDisplaysError(): void
    {
        ...
        $this->formElementManager->method('get')->with(ConfirmEmail::class)->willReturn($form);
        $this->userService->method('resendActivateEmail')->with('test@example.com')->willReturn(false);
