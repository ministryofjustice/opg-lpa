...
class User
{
     ...
     * @param ?string $sharedSpaceId The id of the shared space the user belongs to (or null if they dont).
     */
    ...
    public function setSharedSpaceId(?string $sharedSpaceId): void
    {
        $this->sharedSpaceId = $sharedSpaceId;
    }
}
