...
class CheckoutHelper
{
    ...
    private static function constructPaymentTransactionId(string $lpaId): string
    {
        if (strlen($lpaId) > self::LPA_ID_LENGTH) {
            throw new RuntimeException('LPA ID is too long');
        }
     ...
     */
    private function verifyLpaPaymentAmount(Lpa $lpa, int $ifMatchVersion): int
    {
