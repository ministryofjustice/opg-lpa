...
class ClientSpec extends ObjectBehavior
{
     ...
     * tested here.
     *
     * To reinstate, remove the "" from the function name
     */
    function it_can_combine_several_pages_of_applications_into_a_single_array()
    {
        $numApplications = 900;
    ...
    public function getMatchers()
    {
        return [
            'beAToken' => function($subject) {
                return preg_match('/^[a-z0-9]{64}$/', $subject) !== false;
            },
