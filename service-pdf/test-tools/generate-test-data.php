...
class JsonGenerator extends Randomizer
{
    ...
    protected $applicant;
    protected $hasTrust = null;
    public const HW = 'health-and-welfare';
    public const PF = 'property-and-financial';
    ...
    {
        if (empty($this->replacementAttorneys)) {
            return null;
        }
