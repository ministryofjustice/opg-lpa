...
RESPONSE=$(curl -X DELETE -v -H "Accept: application/vnd.github+json" -H "Authorizartion: Bearer ${GITHUB_TOKEN}" https://api.github.com/repos/ministryofjustice/opg-lpa/environments/$1)
