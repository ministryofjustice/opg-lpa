...
RESPONSE=$(curl -X DELETE -v -H "Accept: application/vnd.github+json" -H "Authorization: Token ${GITHUB_TOKEN}" https://api.github.com/repos/ministryofjustice/opg-lpa/environments/$1)
