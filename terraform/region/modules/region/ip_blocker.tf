module "ip_blocker" {
  ...
  count                        = var.account.web_application_firewall.waf_ip_blocking_enabled ? 1 : 0
  ...
  waf_ip_blocking_enabled      = var.account.web_application_firewall.waf_ip_blocking_enabled
