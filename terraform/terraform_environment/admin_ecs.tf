  ...
  admin_web = <<EOF
  {
    ...
    "logConfiguration": {
        ...
        "options": {
            ...
            "awslogs-stream-prefix": "admin-web.online-lpa"
        }
    },
    "environment": [
    {
  ...
  admin_app = <<EOF
  {
    ...
    "logConfiguration": {
        ...
        "options": {
            "awslogs-group": "${data.aws_cloudwatch_log_group.online-lpa.name}",
            "awslogs-region": "eu-west-1",
            "awslogs-stream-prefix": "admin-app.online-lpa"
        }
    },
    "secrets": [
  ...
  "environment": [
    {
      ...
      "value": "${local.dns_namespace_env}${var.accounts[local.account_name].admin_dns} localhost 127.0.0.1"
    },
    {
