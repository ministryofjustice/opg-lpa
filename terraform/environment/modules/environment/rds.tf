...
module "api_aurora" {
  ...
  deletion_protection             = var.environment.database.deletion_protection
  engine_version                  = var.environment.database.psql_engine_version
  environment                     = var.environment_name
  aws_rds_cluster_parameter_group = data.aws_rds_cluster_parameter_group.postgresql_aurora_params[var.environment.database.psql_parameter_group_family].name
