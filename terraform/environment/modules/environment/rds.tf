...
resource "aws_db_instance" "api" {
  ...
  parameter_group_name                = aws_db_parameter_group.postgres_db_params[var.account.psql_parameter_group_family].name
...
module "api_aurora" {
  ...
  aws_rds_cluster_parameter_group = aws_rds_cluster_parameter_group.postgresql_aurora_params[var.account.psql_parameter_group_family].name
