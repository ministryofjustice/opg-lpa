...
resource "aws_ecs_service" "api" {
  ...
  desired_count                      = var.environment.autoscaling.api.minimum
  launch_type                        = "FARGATE"
  ...
  api_app = jsonencode(
    {
      ...
      environment = [
        ...
        { name = "OPG_LPA_PROCESSING_STATUS_ENDPOINT", value = var.environment.sirius_api_gateway_endpoint },
        ...
        { name = "OPG_LPA_AUTH_TOKEN_TTL", value = tostring(var.environment.auth_token_ttl_secs) },
