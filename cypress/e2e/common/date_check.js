...
Then(
  'I can see validation errors refer to the person signing on behalf of the donor, who is also the applicant',
  () => {
    const donorText =
...
Then(
  'I fill in the {string} signature dates with {string}',
  (fieldset, day) => {
...
Then(
  'I can see applicant validation errors about person signing on behalf of the applicant not signing in the future',
  () => {
    const errorText =
...
Then(
  'I can see applicant validation errors about person signing on behalf of applicant not signing before attorneys',
  () => {
    const errorText =
...
Then(
  'I can see errors about the certificate provider not signing before the donor',
  () => {
    const errorText =
...
Then(
  'I can see primary attorney errors explaining that the donor must be the first person to sign',
  () => {
    const errorText =
      'The donor must be the first person to sign the LPA. ' +
      'You need to print and re-sign sections 10, 11 and 15';
...
Then(
  'I can see applicant errors explaining that the donor must be the first person to sign',
  () => {
    const errorText =
      'The donor must be the first person to sign the LPA. ' +
      'You need to print and re-sign sections 10, 11 and 15';
...
Then(
  'I can see applicant errors explaining that the applicant must sign on or after date when section 11s were signed',
  () => {
    const errorText =
...
Then(
  "I can see a warning that the donor's signature date cannot be in the future",
  () => {
    const errorText =
...
Then(
  "I can see a warning that the primary attorneys' signature dates cannot be in the future",
  () => {
    const errorText =
...
Then(
  "I can see a warning that the certificate provider's signature date cannot be in the future",
  () => {
    const errorText =
...
Then(
  "I can see a warning that the applicant's signature date cannot be in the future",
  () => {
    const errorText =
...
Then(
  'I can see donor errors explaining that the donor must sign section 9 after section 5',
  () => {
    const errorText =
