...
final class ServiceTest extends AbstractServiceTestCase
{
    ...
    public function testCreateInvalidType()
    {
        ...
        $this->service->create(strval($lpa->getId()), self::IF_MATCH_VALUE, self::USER_ID_VALUE, $attorneyArray);
    }
    ...
    public function testCreateValidationFailed()
    {
        ...
        $attorney = new Human();
        $validationError = $this->service->create(strval($lpa->getId()), self::IF_MATCH_VALUE, self::USER_ID_VALUE, $attorney->toArray());
    ...
    public function testUpdateInvalidType()
    {
        ...
        $attorneyArray = $attorney->toArray();
        $attorneyArray['type'] = 'Invalid';
        $this->service->update(strval($lpa->getId()), self::IF_MATCH_VALUE, self::USER_ID_VALUE, $attorneyArray, $lpa->getDocument()->getReplacementAttorneys()[2]->id);
    }
    ...
    public function testUpdateValidationFailed()
    {
        ...
        $attorney = new Human();
        $validationError = $this->service->update(strval($lpa->getId()), self::IF_MATCH_VALUE, self::USER_ID_VALUE, $attorney->toArray(), $lpa->getDocument()->getReplacementAttorneys()[1]->id);
