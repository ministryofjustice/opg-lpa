...
final class ServiceTest extends AbstractServiceTestCase
{
    ...
    public function testUpdateInvalidType()
    {
        ...
        $attorneyArray = $attorney->toArray();
        $attorneyArray['type'] = 'Invalid';
        $service->update(strval($lpa->getId()), $attorneyArray, $lpa->getDocument()->getReplacementAttorneys()[2]->id);
    ...
    public function testUpdateValidationFailed()
    {
        ...
        $attorney = new Human();
        $validationError = $service->update(strval($lpa->getId()), $attorney->toArray(), $lpa->getDocument()->getReplacementAttorneys()[1]->id);
