...
use Application\Controller\Version2\Lpa\WhoIsRegisteringController;
...
class WhoIsRegisteringControllerTest extends AbstractControllerTestCase
{
    ...
    public function getController(array $parameters = []): WhoIsRegisteringController
    {
        $this->service = Mockery::mock(Service::class);

        $controller = new WhoIsRegisteringController($this->authenticationService, $this->service);
