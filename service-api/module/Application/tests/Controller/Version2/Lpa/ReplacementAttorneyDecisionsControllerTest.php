...
use Application\Controller\Version2\Lpa\ReplacementAttorneyDecisionsController;
...
class ReplacementAttorneyDecisionsControllerTest extends AbstractControllerTestCase
{
    ...
    public function getController(array $parameters = []): ReplacementAttorneyDecisionsController
    {
        $this->service = Mockery::mock(Service::class);

        $controller = new ReplacementAttorneyDecisionsController($this->authenticationService, $this->service);
