...
use Application\Controller\Version2\Lpa\PrimaryAttorneyDecisionsController;
...
class PrimaryAttorneyDecisionsControllerTest extends AbstractControllerTestCase
{
    ...
    public function getController(array $parameters = []): PrimaryAttorneyDecisionsController
    {
        $this->service = Mockery::mock(Service::class);

        $controller = new PrimaryAttorneyDecisionsController($this->authenticationService, $this->service);
    ...
    public function testUpdateSuccess()
    {
        ...
        $this->service->shouldReceive('update')->withArgs([$this->lpaId, self::IF_MATCH_VALUE, ['some' => 'data']])
