...
use Application\Controller\Version2\Lpa\ReplacementAttorneyController;
...
class ReplacementAttorneyControllerTest extends AbstractControllerTestCase
{
    ...
    public function getController(array $parameters = []): ReplacementAttorneyController
    {
        ...
        $controller = new ReplacementAttorneyController($this->authenticationService, $this->service);
