...
use Application\Controller\Version2\Lpa\PreferenceController;
...
class PreferenceControllerTest extends AbstractControllerTestCase
{
    ...
    public function getController(array $parameters = []): PreferenceController
    {
        $this->service = Mockery::mock(Service::class);

        $controller = new PreferenceController($this->authenticationService, $this->service);
