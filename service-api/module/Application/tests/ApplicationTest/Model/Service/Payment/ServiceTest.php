...
class ServiceTest extends AbstractServiceTest
{
    ...
    public function testUpdateValidationFailed()
    {
        ...
        $validationError = $service->update($payment->toArray(), -1); //Id is ignored
    ...
    public function testUpdateMalformedData()
    {
        ...
        $service->update($lpa->payment->toArray(), -1); //Id is ignored
    ...
    public function testUpdate()
    {
        ...
        $entity = $service->update($payment->toArray(), -1); //Id is ignored
