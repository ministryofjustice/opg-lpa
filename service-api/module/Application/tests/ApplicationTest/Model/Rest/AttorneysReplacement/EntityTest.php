...
class EntityTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->entity = new Entity($this->lpa->document->replacementAttorneys[0], $this->lpa);
    }
    ...
    {
        $this->assertEquals($this->lpa->document->replacementAttorneys[0]->id, $this->entity->resourceId());
    }
