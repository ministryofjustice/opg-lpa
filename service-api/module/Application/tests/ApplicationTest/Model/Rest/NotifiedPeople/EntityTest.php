...
class EntityTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->entity = new Entity($this->lpa->document->peopleToNotify[0], $this->lpa);
    }
    ...
    {
        $this->assertEquals($this->lpa->document->peopleToNotify[0]->id, $this->entity->resourceId());
    }

    public function testToArray()
    {
        $this->assertEquals($this->lpa->document->peopleToNotify[0]->toArray(), $this->entity->toArray());
    }
