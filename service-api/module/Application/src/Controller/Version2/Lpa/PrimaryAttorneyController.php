...
class PrimaryAttorneyController extends AbstractLpaController
{
    ...
    public function create($data)
    {
        ...
        $result = $this->getService()->create($this->params()->fromRoute('lpaId'), $this->ifMatch(), $data);
    ...
    public function update($id, $data)
    {
        ...
        $result = $this->getService()->update($this->params()->fromRoute('lpaId'), $this->ifMatch(), $data, $id);
    ...
    public function delete($id)
    {
        ...
        $result = $this->getService()->delete($this->params()->fromRoute('lpaId'), $this->ifMatch(), $id);
