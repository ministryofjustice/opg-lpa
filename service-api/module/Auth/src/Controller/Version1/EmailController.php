...
class EmailController extends AbstractAuthenticatedController
{
    use LoggerTrait;
    ...
    public function __construct(AuthenticationService $authenticationService, EmailUpdateService $emailUpdateService)
    {
